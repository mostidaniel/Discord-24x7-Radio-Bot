...
function generateQueueEmbed(message, queue) {
  ...
  for (let i = 0; i < queue.length; i += 10) {
    ...
    const embed = new MessageEmbed()
     .setAuthor("Server Songs Queue", "https://raw.githubusercontent.com/navaneethkm004/my-images/main/giphy.gif")
    ...
    .setFooter("Currently Server Volume is "+serverQueue.volume)
     if(serverQueue.songs.length === 1)embed.setDescription(`No songs to play!!`)
